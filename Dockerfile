...
# https://lahuman.github.io/dockerfile_alpine_puppeteer/ [DockerfileR] node:Alpine에서 puppeteer 기동 & 한글 깨짐 처리
...
# 사용자 정보 및 앱 사용 동의를 환경변수에 저장
ENV AGREE false
ENV ID 이 문장을 지우고 네이버 아이디를 입력하세요.
ENV PW 이 문장을 지우고 네이버 비밀번호를 입력하세요.
